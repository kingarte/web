$(function() {
  ...
  $('.comment a.comment-reply').click(function(e) {
	...
	top_li.find('.comment-replybox-single').first().append('<div class="cancel-reply"><button class="cancel-button" type="button">Cancelar</button></div>');
  ...
  $('#top-continue.continue>a.comment-reply').click(function(e) {
	...
	$('.comment-replybox-thread').append('<div class="cancel-reply"><button class="cancel-button" type="button">Cancelar</button></div>')
    $('.cancel-reply').click(function() {
	  $('#comments .cancel-reply').remove()
